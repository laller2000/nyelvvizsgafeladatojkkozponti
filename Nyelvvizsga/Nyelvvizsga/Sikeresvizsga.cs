...
namespace Nyelvvizsga
{
    class Sikeresvizsga
    {
        ...
        public int Ev18 { get => ev18; set => ev18 = value; }

        public Sikeresvizsga(string nyelv, int ev9, int ev10, int ev11, int ev12, int ev13, int ev14, int ev15, int ev16, int ev17, int ev18)
        {
            Nyelv = nyelv;
            Ev9 = ev9;
            Ev10 = ev10;
        ...
        public Sikeresvizsga(string sor)
        {
